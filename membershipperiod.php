...
require_once CRM_Membershipperiod_ExtensionUtil::path('CRM\Membershipperiod\Membershipperiod.php');
 ...
 * Alexander Ferreras    ferrerasalexander@gmail.com
 * Additional function, this call all template presentation en contact summary
 * @link http://wiki.civicrm.org/confluence/display/CRMDOC/hook_civicrm_config
 */
function membershipperiod_civicrm_pageRun(&$page) {
  CRM_MembershipPeriod_Controller::pageRun($page);
}

function membershipperiod_civicrm_pre( $op, $objectName, $objectId, &$objectRef ){
  CRM_MembershipPeriod_Controller::pre( $op,$objectName,$objectId,$objectRef);
}
...
function membershipperiod_civicrm_entityTypes(&$entityTypes) {
  _membershipperiod_civix_civicrm_entityTypes($entityTypes);
}
...
function membershipperiod_civicrm_navigationMenu(&$menu) {
  _membershipperiod_civix_insert_navigation_menu($menu, 'Mailings', array(
